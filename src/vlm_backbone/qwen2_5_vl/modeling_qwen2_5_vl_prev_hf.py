        ...
        *args, **kwargs
        ...
        if inputs_embeds is None:
            ...
            if pixel_values is not None:
                ...
                image_grid_thw = [image_grid_thw[i] if isinstance(image_grid_thw[i], torch.Tensor) else torch.from_numpy(image_grid_thw[i]) for i in range(len(image_grid_thw))]
                image_grid_thw = torch.cat(image_grid_thw).to(device=input_ids.device, dtype=torch.int64)  # shape=[BS,H,W]
