...
class MSRVTTDatasetProcessor(VideoDatasetProcessor):
    def __init__(self, model_args, data_args, training_args, **kwargs):
        super().__init__("msrvtt", model_args, data_args, training_args, **kwargs)

    def _load_hf_dataset(self):
        return load_dataset(DATASET_HF_PATH, "train_9k", split="train")
