...
from ...model.processor import LLAVA_NEXT, QWEN2_VL, QWEN2_5_VL, PHI3V, QWEN2_VL_TOKENSELECTION, QWEN2_5_VL_TOKENSELECTION, process_vlm_inputs_fns
...
class EvalCollator:
    ...
    def __call__(self, examples):
        ...
        """
        examples = {'texts': [e[0] for e in examples], 'images': [e[1] for e in examples]}
        inputs = process_vlm_inputs_fns[self.model_args.model_backbone](examples,
                                                                        processor = self.processor,
                                                                        max_length = self.data_args.max_len)
        inputs['texts'] = examples['texts']
...
class MultimodalEvalDataCollator:
    ...
    def _get_batch_inputs_baseline(self, batch, text_keyname, image_keyname):
        texts, visual_inputs = [], []
