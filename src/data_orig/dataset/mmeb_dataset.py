...
# from ..prompts import get_query, get_target, format_description, format_text
...
#             qry_text = format_text(processor, qry_text, qry_image_path, description=qry_description, add_generation_prompt=not is_train and model_args.do_sft_query)
#             pos_text = format_text(processor, pos_text, pos_image_path, description=pos_description, add_generation_prompt=not is_train and model_args.do_sft_target)
#         else:
...
#     # dataset = dataset.drop_duplicates(subset=[qry_text_field, qry_image_field])
...
#                           remove_columns=remove_columns, drop_last_batch=True, load_from_cache_file=False,)
